...
'use client'; // This file is interactive
...
export default function MergeTool() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
      {/* Page Header with new SEO text */}
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">The Ultimate Tool to Merge PDF Files</h1>
        <p className="text-lg text-gray-400 max-w-3xl mx-auto">
          Experience true control. Combine files, reorder individual pages, and delete what you don't need—all with 100% privacy.
        </p>
      </div>
      ...
      <div className="mt-20 text-gray-300 prose prose-invert max-w-none prose-p:text-gray-300 prose-h2:text-gray-100 prose-h3:text-gray-200 prose-h4:text-gray-200">
        ...
        <p>
          Tired of basic PDF mergers that just stitch files together? The DocEnclave PDF Merger is designed for precision and privacy. Unlike other online tools that force you to upload sensitive documents, our tool works entirely within your browser. This means your files stay on your device, secure and confidential.
        </p>
        <p>
          But true innovation lies in control. We don't just let you combine files; we give you a complete visual workspace. See every single page, drag them into the perfect order, and delete unwanted pages with a single click before you merge. It's the power of a desktop application, with the convenience of a web tool, and the security of working offline.
        </p>
        
        <h3 className="text-2xl font-bold mt-12 mb-4">Total Control Over Your Pages</h3>
        <p>
          Don't just merge files—orchestrate your document. Our interactive preview lets you see every page from all your uploaded PDFs in one place. Drag a cover page from one file to the front, move an appendix from another to the back, and delete blank or incorrect pages on the fly. This is the level of detail that ensures your final document is perfect.
        </p>

        <h3 className="text-2xl font-bold mt-12 mb-4">Unyielding Privacy and Security</h3>
        <p>
          Security isn't a feature; it's our foundation. When you use DocEnclave, there are zero file uploads. The entire merging process, from file selection to the final creation of your new PDF, happens locally on your computer. Your contracts, reports, and personal documents never touch our servers, or anyone else's.
        </p>

        <h2 className="text-3xl font-bold mt-16 mb-8">Frequently Asked Questions</h2>
        <div className="space-y-8">
          <div>
            <h4 className="text-xl font-semibold">How do I merge PDF files with this tool?</h4>
            <p>It's simple. 1) Click the upload box and select all the PDF files you want to combine. 2) In the preview area, drag and drop individual pages to get the exact order you need. 3) Delete any pages you don't want. 4) Click the "Merge Pages" button to create and download your new, perfectly organized PDF.</p>
          </div>
          <div>
            <h4 className="text-xl font-semibold">Is it truly free to combine PDFs here?</h4>
            <p>Yes, completely. Our client-side tools, including the advanced PDF merger, are 100% free to use with no limits, watermarks, or registration required.</p>
          </div>
          <div>
            <h4 className="text-xl font-semibold">Can I reorder pages from different PDF files?</h4>
            <p>Absolutely! This is what makes our tool unique. You can take page 5 from your first PDF and place it after page 2 of your second PDF. The preview area shows all pages from all files as one single collection for you to arrange.</p>
          </div>
          <div>
            <h4 className="text-xl font-semibold">Are my files safe when I merge them?</h4>
            <p>Your files are as safe as they are on your own computer, because they never leave it. By processing everything in your browser, DocEnclave eliminates the risk associated with uploading documents to third-party servers, offering the highest level of privacy.</p>
          </div>
        </div>
      </div>
    </div>
